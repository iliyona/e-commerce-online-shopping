  ...
  <div class="modal-content">
	<div class="modal-header">
		...
		<table>
			<tr>
				<td align="center"> 
				<img src="<?php echo web_root; ?>images/home/logo3.png"   alt="Image">
        		</td> 
			</tr>
		</table>
...
<?php 
	 $query = "SELECT * FROM `tblsummary` s ,`tblcustomer` c 
		...
		if ($cur->PAYMENTMETHOD=="Online Banking") {
			 
		
?>
 	 <h4>Your order has been confirmed and ready for Delivered</h4><br/>
		<h5>DEAR sweetie ,</h5>
		<h5>As you have ordered payment through online banking, please transfer money to account: MBB/14300971821.</h5>
		 <hr/>
...
<hr/>
 <h4><strong>Order Information</strong></h4>
		...
		?>
 		...
 		<div class="row">
		  ...
		  ?>
		   <hr/> 
		  <div class="row">
		 		 <p>Please screen shot this as a proof of purchased</p><br/>
		  	  <p>We hope you enjoy your purchased products^^ Have a nice day!</p>
		  	  <p>Sincerely,</p>
		  	  <h4><a href="https://bit.ly/2LPn9Wu">KNITWEAR-CO</a></h4>
		  </div>
		  <?php }?>
  </div> 
		...
		<?php if($cur->ORDEREDSTATS!='Pending' || $cur->ORDEREDSTATS!='Cancelled' ){ ?> 
                ...
                <!--<button  onclick="tablePrint();" class="btn btn_fixnmix pull-right "><span class="glyphicon glyphicon-print" ></span> </button>-->     
