      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Total Price :   RM <span id="sum">0.00</span></div>
                   <div > Delivery Fee : RM <span id="fee">0.00</span></div>
                   <div> Overall Price : RM <span id="overall"><?php echo $tot ;?></span></div>
         ...
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                   ...
                   <div class="radio" >
                      <label >
                          <input type="radio"  class="paymethod" name="paymethod" id="deliveryfee" value="Online Banking" checked="true" data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >Online Banking 
                        ...
                        <div class="panel"> 
                                <div class="panel-body">
                                    <div class="form-group ">
                                      <label>Please choose courier</label>
